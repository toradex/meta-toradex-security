...
generate_csf_spl() {
    ...
    sed -i "s|CST_SRK|${TDX_IMX_HAB_CST_SRK}|g" ${CSF_SPL}.csf
    sed -i "s|CST_CSF_CERT|${TDX_IMX_HAB_CST_CSF_CERT}|g" ${CSF_SPL}.csf
    sed -i "s|CST_IMG_CERT|${TDX_IMX_HAB_CST_IMG_CERT}|g" ${CSF_SPL}.csf
